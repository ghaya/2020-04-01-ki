...
<hr/>
<h2>Registration</h2>
<p>Registration is open to people affiliated with KI, KTH or SU. <p> <a href="https://kib.ki.se/en/node/17421/register"><button type="button" class="btn btn-info">Register now</button></a></p>
  </p>
  <hr/>
